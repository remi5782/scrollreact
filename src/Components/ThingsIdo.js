...
import mockTID from '../Utils/mockTID';
...
export default function ThingdsIdo({ title, subtitle, dark, id, activeContent }){
      ...
      <Typography variant="h3">
        ...
        <Grid container className={classes.root}   spacing={2} gutterBottom> 
            ...
            <Grid item lg={3} xs={12}>
                <MediaCard activeContent={activeContent} additionalClass={'toiCard'} {...data}/>
            </Grid>))}
        </Grid>
    </div></div>
    )
